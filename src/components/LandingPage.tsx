    ...
    >
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div 
            className="bg-white text-[#111877] rounded-lg shadow-lg p-6 flex flex-col items-center justify-center h-48 cursor-pointer transition-transform duration-200 ease-in-out hover:scale-105 hover:shadow-xl"
