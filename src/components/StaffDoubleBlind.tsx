...
// import { UpdateDetails } from '../contexts/RecordContext';
...
//   const [isLayoutConfirmModalOpen, setIsLayoutConfirmModalOpen] = useState(false);
...
//   const handleViewDetails = (manuscript: typeof ManuscriptDetails) => {
//     setSelectedManuscript(manuscript as ExtendedManuscriptDetails);
//     setIsModalOpen(true);
//   };
//   const handleProceedToLayout = () => {
//     if (selectedManuscript && layoutArtist) {
...
//       setLayoutArtist('');
//       setIsLayoutConfirmModalOpen(false);
//     }
//   };  const handleProceedToLayoutConfirm = () => {
//     setIsLayoutModalOpen(false);
//     setIsLayoutConfirmModalOpen(true);
//   };
...
//                 <td className="py-4 px-4">
//                   <button
//                     onClick={() => handleViewDetails(record as RecordContextType)}
...
//       {isLayoutConfirmModalOpen && selectedManuscript && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
//           <div className="bg-white p-6 rounded-lg w-[500px]">
//             <div className="flex justify-between items-center mb-4">
//               <h3 className="text-xl font-semibold">Confirm Layout Transition</h3>
//               <button onClick={() => setIsLayoutConfirmModalOpen(false)} className="text-gray-500 hover:text-gray-700">
//                 <X size={24} />
//               </button>
//             </div>
//             <div className="space-y-4">
...
//             <div className="mt-6 flex justify-end space-x-4">
//               <button
//                 onClick={() => setIsLayoutConfirmModalOpen(false)}
//                 className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50"
//               >
//                 Cancel
//               </button>
...
//       {/* Status Modal */}
//       {isStatusModalOpen && selectedManuscript && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
//           <div className="bg-white p-6 rounded-lg w-[500px]">
//             <div className="flex justify-between items-center mb-4">
