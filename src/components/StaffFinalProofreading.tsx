          ...
          <div className="bg-white p-6 rounded-lg w-[600px]">
            ...
            <div className="space-y-4">
              ...
              {selectedRecord.layoutDetails?.revisionStatus && (
                <div>
                  <label className="font-semibold block">Layout Revision Status:</label>
                  <p className="text-blue-600">{selectedRecord.layoutDetails.revisionStatus}</p>
                </div>
              )}
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-96">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <div>
                <h4 className="text-lg font-semibold">Manuscript Published Successfully</h4>
                <p className="text-green-600 mt-2">The manuscript has been published and is now available in the published section.</p>
              </div>
            </div>
            <button
